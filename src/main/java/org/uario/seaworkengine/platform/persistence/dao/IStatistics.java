...
public interface IStatistics {
	 ...
	 * @return
	 */
	public List<ShipTotal> getTotalHandsMen(final Integer year, final Integer shift, Integer idService,
	...
	public List<DetailFinalSchedule> listDetailFinalSchedule(String full_text_search, Integer shift_number,
			Integer shift_type, Integer task_id, Date date_from, Date date_to, Boolean reviewshift, Integer idShip,
			String crane, Integer rf_sws);
	...
	public List<ReviewShipWork> loadReviewShipWork(Date date_from, Date date_to, String searchText, Integer rifSWS,
			String rifMCT, Integer shift, Integer invoicing_cycle, Integer serviceId, String shipType, String shipLine,
	 ...
	 * @return
	 */
	public List<ReviewShipWorkAggregate> loadReviewShipWorkAggregate(Date date_from, Date date_to, Integer rifSWS,
			String rifMCT, Integer invoicing_cycle, String searchText, Integer serviceId, String shipType,
	...
	public List<ShipOverview> overviewFinalScheduleByShip(String text_search, Date date_from, Date date_to,
			String shipType, String shipLine, String shipCondition);
