...
public class MyBatisConfigurationDAO extends SqlSessionDaoSupport implements ConfigurationDAO {
	...
	@Override
	public void addStatus(final String status, String note) {
	...
	public List<UserShift> listAllShifts(final String full_text_search) {
		...
		final List<UserShift> list_shift = this.getSqlSession()
				.selectList("configuration.selectAllShiftsFulltextSearchLike", map);
		return list_shift;
	...
	public List<UserTask> listAllTasks(final String full_text_search) {
		...
		final List<UserTask> list_task = this.getSqlSession()
				.selectList("configuration.selectAllTasksFulltextSearchLike", map);
		return list_task;
	}
