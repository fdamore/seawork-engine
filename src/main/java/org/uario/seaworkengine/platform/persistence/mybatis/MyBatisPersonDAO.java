...
public class MyBatisPersonDAO extends SqlSessionDaoSupport implements PersonDAO {
	...
	public List<Person> listAllPersonByUserStatus(final String userStatus) {
		...
		return this.getSqlSession().selectList("person.listAllPersonByUserStatus", userStatus);
	...
	@Override
	public List<Person> listAllPersonByUserTask(final Integer id_usertask) {
		MyBatisPersonDAO.logger.info("listAllPersonByUserTask");
		final List<Person> list_person = this.getSqlSession().selectList("person.listAllPersonByUserTask", id_usertask);
		return list_person;
	}
	...
	@Override
	public List<UserReport> listUserReport() {

		MyBatisPersonDAO.logger.info("list UserReport");
		return this.getSqlSession().selectList("person.user_report");
