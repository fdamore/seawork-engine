...
public class SchedulerComposer extends SelectorComposer<Component> {
	 ...
	 */
	@Listen("onChange = #scheduler_type_selector, #date_init_scheduler, #date_init_scheduler_review, #select_shift_overview,#select_shifttype_overview, #taskComboBox, #hoursInterval; onOK = #date_to_overview, #date_from_overview, #date_init_scheduler, #date_init_scheduler_review, #shows_rows, #full_text_search; onSelect = #overview_tab")
	...
	public void downdoadOverviewCSV() {
		...
		if (this.overview_review.isSelected() && (this.listDetailRevision != null)) {
			...
			final StringBuilder builder = UtilityCSV.downloadCSVReview(this.listDetailRevision, this.task_cache, this.shift_cache, this.ship_cache);
		...
		} else if (this.overview_statistics_ship.isSelected() && (this.listShipStatistics != null)) {
			final StringBuilder builder = UtilityCSV.downloadCSVShipStatistics(this.listShipStatistics);

			Filedownload.save(builder.toString(), "application/text", "shipstatistics.csv");
		}
	...
	public void saveReviewItem() {
		...
		final DetailFinalSchedule itm = this.listbox_review.getSelectedItem().getValue();
	...
	private void setOverviewLists(final Date date_from_overview, final Date date_to_overview) {
		...
		else if (this.overview_statistics_ship.isSelected()) {

			this.refreshShipStatistics(full_text_search);
		}
