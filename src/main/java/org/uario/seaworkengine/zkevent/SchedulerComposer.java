...
public class SchedulerComposer extends SelectorComposer<Component> {
	 ...
	 */
	@Listen("onClick = #shift_period_ok; onChange = #scheduler_type_selector, #date_init_scheduler, #date_init_scheduler_review, #select_shift_overview,#select_shifttype_overview, #date_to_overview, #date_from_overview;onOK = #shows_rows, #full_text_search; onSelect = #overview_tab")
	...
	public void downdoadOverviewCSV() {
		...
		if (this.overview_review.isSelected() && (this.listDetailRevision != null)) {
			...
			for (final DetailFinalSchedule item : this.listDetailRevision) {
				...
				final String line = "" + item.getUser() + ";" + date + ";" + code_shift + ";" + item.getShift() + ";" + code_task + ";" + item.getTime() + ";" + time_from + ";" + time_to + ";\n";
				builder.append(line);
			}
			...
			if (this.listDetailProgram != null) {
				...
				for (final DetailInitialSchedule item : this.listDetailProgram) {
					...
					final String line = "" + item.getUser() + ";" + date + ";" + code_shift + ";" + item.getShift() + ";" + code_task + ";" + item.getTime() + ";\n";
					builder.append(line);
				}
