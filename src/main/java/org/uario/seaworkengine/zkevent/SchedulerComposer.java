...
public class SchedulerComposer extends SelectorComposer<Component> {
	...
	private void mainSchedulerView(final String version) {
		...
		if (version == null) {
			...
			SchedulerComposer.this.scheduler_type_selector.setSelectedItem(SchedulerComposer.this.program_item);
		}
						...
						new EventListener<ClickEvent>() {
							...
							public void onEvent(final ClickEvent e) {
								...
								if (Messagebox.ON_OK.equals(e.getName())) {
									...
									SchedulerComposer.this.saveDayShiftProcedure(shift, row_item, date_scheduled,
									scheduleListInWeek);
