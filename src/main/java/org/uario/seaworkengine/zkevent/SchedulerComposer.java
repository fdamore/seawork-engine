...
public class SchedulerComposer extends SelectorComposer<Component> {
	...
	private void setOverviewLists() {
		if (this.overview_review.isSelected()) {
			final List<DetailFinalSchedule> list = this.statisticDAO.listDetailFinalSchedule();
			...
			final List<DetailInitialSchedule> list = this.statisticDAO.listDetailInitialSchedule();
