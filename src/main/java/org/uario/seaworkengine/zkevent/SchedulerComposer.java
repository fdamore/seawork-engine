...
public class SchedulerComposer extends SelectorComposer<Component> {
	...
	private void setOverviewLists(final Date date_from_overview, final Date date_to_overview) {
		...
		if (this.overview_review.isSelected()) {
			...
			this.listDetailRevision = this.statisticDAO.listDetailFinalScheduleOnly(full_text_search, shift_number, shift_type, idSelectedTask,
					date_from, date_to, reviewshift, idShip, idCrane, my_rif_sws);
			...
			this.listDetailProgram = this.statisticDAO.listDetailInitialScheduleOnly(full_text_search, shift_number, shift_type, idSelectedTask,
					date_from, date_to);
