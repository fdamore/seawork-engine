...
public class ShipDetailsComposer extends SelectorComposer<Component> {
	...
	@Wire
	private Checkbox			customer_enabled;
	...
	public void addCustomerOK() {
		...
		if (!this.status_modify.booleanValue()) {
			...
			customer.setEnabled(this.customer_enabled.isChecked());
			...
			if (this.customer_selected != null) {
				...
				this.customer_selected.setEnabled(this.customer_enabled.isChecked());
	...
	public void showAddCustomer() {
		...
		this.customer_enabled.setChecked(Boolean.TRUE);
