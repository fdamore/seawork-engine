...
public class ShipSchedulerComposer extends SelectorComposer<Component> {
	...
	private void forecastingForMonthShipProgram(final Date date_from) {
		...
		final List<ScheduleShip> list_month = this.shipSchedulerDao.searchScheduleShip(first_day_month, last_day_month, null, null, null, null, null,
				null, null, null);
	...
	public void updateCustomerComplaint() {
		if ((this.customerComplaint == null) || (this.select_year_detail.getSelectedItem() == null)
				|| (this.selectCustomer.getSelectedItem() == null) || (this.selectCustomer.getSelectedItem().getValue() == null)) {
			return;
		}
