...
public class ShipSchedulerComposer extends SelectorComposer<Component> {
	...
	@Listen("onChange = #select_workedShip, #select_typeShip, #select_type_operation,#scheduler_type_selector, #searchArrivalDateShipFrom,#searchArrivalDateShipTo, #select_customer, #selectServiceDetail, #select_shift; onSelect = #bap_overview_tab; onOK=#searchArrivalDateShipFrom,#searchArrivalDateShipTo, #shows_rows, #full_text_search,#invoicing_cycle_search,#ship_type_search,#ship_line_search,#ship_condition_search; onClick = #remove_select_shift, #remove_searchDateShift, #remove_select_typeShip,#remove_select_operation_type,#remove_select_workedShip,#remove_select_customer, #removeServiceFilterDetail;  onCheck = #datashift_period, #initial_support_date")
	public void defineSchedulerView() {
		...
		this.filter_operation_type.setVisible(false);
		...
		if (selected.equals(this.program_item)) {
			...
			this.filter_operation_type.setVisible(true);
