...
public class UserDetailsComposerTrainingCertificate extends SelectorComposer<Component> {
	...
	@Wire
	private Doublebox				training_duration;

	@Wire
	private Datebox					training_end_class;

	@Wire
	private Textbox					training_level;

	@Wire
	private Datebox					training_start_class;
	...
	public void modifyItem() {
		...
		this.training_duration.setValue(item.getDuration());
	...
	private void setupItemWithValues(final TrainingCertificate item) {
		...
		item.setDuration(this.training_duration.getValue());
