...
public class IdEmployComparatorPerson implements Comparator<Person> {

	private final boolean asc_dir;

	public IdEmployComparatorPerson(final boolean asc) {
		this.asc_dir = asc;
	}

	@Override
	public int compare(final Person item_1, final Person item_2) {
